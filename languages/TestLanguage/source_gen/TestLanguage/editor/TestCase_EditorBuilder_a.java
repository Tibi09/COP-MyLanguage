...
/*package*/ class TestCase_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new contentListHandler_g8b7hx_d0(myNode, getEditorContext());
  ...
  private static class contentListHandler_g8b7hx_d0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public contentListHandler_g8b7hx_d0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(contentListHandler_g8b7hx_d0.this.getNode(), LINKS.content$iiBZ));
      try {
