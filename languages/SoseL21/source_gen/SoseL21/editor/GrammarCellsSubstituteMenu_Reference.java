...
public class GrammarCellsSubstituteMenu_Reference extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Reference() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_4q2gnr_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Reference", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_4q2gnr_a extends GrammarCellsSubstituteMenuPart {
    @Override
