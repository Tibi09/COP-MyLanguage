...
public class GrammarCellsSubstituteMenu_StatementContainer extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_StatementContainer() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_dt4bnb_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "StatementContainer", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_dt4bnb_a extends GrammarCellsSubstituteMenuPart {
    @Override
