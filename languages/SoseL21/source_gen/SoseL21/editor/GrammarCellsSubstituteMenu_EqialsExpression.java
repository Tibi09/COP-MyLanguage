...
public class GrammarCellsSubstituteMenu_EqialsExpression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EqialsExpression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_2h8be7_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EqialsExpression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_2h8be7_a extends GrammarCellsSubstituteMenuPart {
    @Override
