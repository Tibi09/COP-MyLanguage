...
/*package*/ class Workspace_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_h7tsgb_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_h7tsgb_a0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_h7tsgb_c0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_h7tsgb_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createCollection_2() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_h7tsgb_c0");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new contentsListHandler_h7tsgb_b2a(myNode, getEditorContext());
  ...
  private static class contentsListHandler_h7tsgb_b2a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public contentsListHandler_h7tsgb_b2a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(contentsListHandler_h7tsgb_b2a.this.getNode(), LINKS.contents$6guO));
      try {
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_h7tsgb_d0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_3() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "}");
    editorCell.setCellId("Constant_h7tsgb_e0");
    editorCell.setDefaultText("");
    return editorCell;
  }
