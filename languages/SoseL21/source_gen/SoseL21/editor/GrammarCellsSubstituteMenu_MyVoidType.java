...
public class GrammarCellsSubstituteMenu_MyVoidType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_MyVoidType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_fyanhn_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "MyVoidType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_fyanhn_a extends GrammarCellsSubstituteMenuPart {
    @Override
