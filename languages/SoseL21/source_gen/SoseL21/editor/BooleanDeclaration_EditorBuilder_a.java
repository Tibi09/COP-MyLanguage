...
/*package*/ class BooleanDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_ybqih9_a0a0() {
    IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.private$bi1D);
  ...
  private EditorCell createAlternation_1() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_ybqih9_a1a0();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private boolean nodeCondition_ybqih9_a1a0() {
    IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.protected$bh5_);
    if (!(access.read(myNode))) {
      return false;
    }
  ...
  private EditorCell createSideTransformationCell4_1() {
    ...
    editorCell.setCellId("SideTransformationCell4_ybqih9_a1a0");
    return editorCell;
  }
  ...
  private EditorCell createAlternation_2() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_ybqih9_a2a0();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private boolean nodeCondition_ybqih9_a2a0() {
    IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.public$bgoy);
    if (!(access.read(myNode))) {
      return false;
    }
  ...
  private EditorCell createSideTransformationCell4_2() {
    ...
    editorCell.setCellId("SideTransformationCell4_ybqih9_a2a0");
    return editorCell;
  }
  ...
  private EditorCell createAlternation_4() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_ybqih9_a6a0();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private EditorCell createCollection_2() {
    jetbrains.mps.nodeEditor.cells.EditorCell_Collection editorCell = new jetbrains.mps.nodeEditor.cells.EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_ybqih9_a0a0g0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_4() {
    ...
    editorCell.setCellId("Constant_ybqih9_a0a0a6a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new valueSingleRoleHandler_ybqih9_b0a0a6a0(myNode, LINKS.value$O2J5, getEditorContext());
    return provider.createCell();
  }
  private static class valueSingleRoleHandler_ybqih9_b0a0a6a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public valueSingleRoleHandler_ybqih9_b0a0a6a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createSideTransformationCell4_4() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for BooleanDeclaration.value") {
      @Override
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new GenericMenuPart_a0a6a0_0());
      }
    };
    editorCell.setCellId("SideTransformationCell4_ybqih9_a6a0");
    return editorCell;
  }
  ...
  private EditorCell createConstant_5() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ";");
    editorCell.setCellId("Constant_ybqih9_h0a");
    Style style = new StyleImpl();
