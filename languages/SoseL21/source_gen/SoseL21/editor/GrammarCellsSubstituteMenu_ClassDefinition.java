...
public class GrammarCellsSubstituteMenu_ClassDefinition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ClassDefinition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_lbj57r_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ClassDefinition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_lbj57r_a extends GrammarCellsSubstituteMenuPart {
    @Override
