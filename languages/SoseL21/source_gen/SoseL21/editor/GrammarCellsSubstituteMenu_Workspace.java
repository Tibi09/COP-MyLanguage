...
public class GrammarCellsSubstituteMenu_Workspace extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Workspace() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_ljkigs_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Workspace", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_ljkigs_a extends GrammarCellsSubstituteMenuPart {
    @Override
