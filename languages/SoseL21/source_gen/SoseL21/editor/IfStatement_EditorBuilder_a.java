...
/*package*/ class IfStatement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new conditionSingleRoleHandler_eb7h0d_c0(myNode, LINKS.condition$_Ae8, getEditorContext());
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new thenListHandler_eb7h0d_g0(myNode, getEditorContext());
  ...
  private static class thenListHandler_eb7h0d_g0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public thenListHandler_eb7h0d_g0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(thenListHandler_eb7h0d_g0.this.getNode(), LINKS.then$_AGa));
      try {
  ...
  private EditorCell createConstant_4() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "}");
    editorCell.setCellId("Constant_eb7h0d_h0");
    Style style = new StyleImpl();
