...
public class GrammarCellsSubstituteMenu_BooleanDeclaration extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BooleanDeclaration() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_8zfvon_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BooleanDeclaration", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_8zfvon_a extends GrammarCellsSubstituteMenuPart {
    @Override
