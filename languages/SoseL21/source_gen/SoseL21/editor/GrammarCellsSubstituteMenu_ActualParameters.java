...
public class GrammarCellsSubstituteMenu_ActualParameters extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ActualParameters() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_3b04uy_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ActualParameters", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_3b04uy_a extends GrammarCellsSubstituteMenuPart {
    @Override
