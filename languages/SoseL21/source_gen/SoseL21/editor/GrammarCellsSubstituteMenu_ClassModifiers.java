...
public class GrammarCellsSubstituteMenu_ClassModifiers extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ClassModifiers() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_bl6u4g_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ClassModifiers", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_bl6u4g_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ClassModifiers$TL;
    }
  }
