...
public class GrammarCellsSubstituteMenu_ParameterDeclaration extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ParameterDeclaration() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_8s9u3a_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ParameterDeclaration", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_8s9u3a_a extends GrammarCellsSubstituteMenuPart {
    @Override
