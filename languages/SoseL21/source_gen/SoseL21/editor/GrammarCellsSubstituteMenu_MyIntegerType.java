...
public class GrammarCellsSubstituteMenu_MyIntegerType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_MyIntegerType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_fgwgns_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "MyIntegerType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_fgwgns_a extends GrammarCellsSubstituteMenuPart {
    @Override
