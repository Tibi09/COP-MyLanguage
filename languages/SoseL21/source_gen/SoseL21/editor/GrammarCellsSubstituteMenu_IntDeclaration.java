...
public class GrammarCellsSubstituteMenu_IntDeclaration extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IntDeclaration() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_bgfvgz_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IntDeclaration", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_bgfvgz_a extends GrammarCellsSubstituteMenuPart {
    @Override
