...
public class GrammarCellsSubstituteMenu_AssignmentExpression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AssignmentExpression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_l8jxv4_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AssignmentExpression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_l8jxv4_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.AssignmentExpression$vb;
    }
  }
