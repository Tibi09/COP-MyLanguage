...
public final class IfStatement__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x675036cf295d4c04L, 0xa4188a54769c9d5cL, 0x66171d77dac8cadaL, "SoseL21.structure.IfStatement");
  ...
  /*package*/ static Iterable<SNode> getStatements_id6on7nvqLDw8(@NotNull SNode __thisNode__) {
    return SLinkOperations.getChildren(__thisNode__, LINKS.then$_AGa);
  }
